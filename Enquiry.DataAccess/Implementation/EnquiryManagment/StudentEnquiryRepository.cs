...
{
    public class StudentEnquiryRepository : GenericRepository<StudentEnquiry>, IStudentEnquiryRepository
    {
        public readonly EnquiryDbContext dbContext;
        public readonly ILogger logger;
        public StudentEnquiryRepository(EnquiryDbContext dbContext, ILogger logger) : base(dbContext, logger)
        {
