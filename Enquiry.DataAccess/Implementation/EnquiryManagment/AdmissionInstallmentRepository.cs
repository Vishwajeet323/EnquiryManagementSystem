...
{
    public class AdmissionInstallmentRepository : GenericRepository<AdmissionInstallment>, IAdmissionInstallmentRepository
    {
        public readonly EnquiryDbContext dbContext;
        public readonly ILogger logger;
        public AdmissionInstallmentRepository(EnquiryDbContext dbContext, ILogger logger) : base(dbContext, logger)
        {
